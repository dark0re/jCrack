...
public final class Sha256Crypt
{
  ...
  static private final int SALT_LEN_MAX = 20;
  ...
  public static final String Sha256_crypt(String keyStr, String saltStr, int roundsCount)
  {
    ...
    ctx.reset();
    //System.out.println("With:\t" + buffer.toString());
  ...
  public final boolean verifyPassword(String plaintextPass, String sha256CryptText)
  {
